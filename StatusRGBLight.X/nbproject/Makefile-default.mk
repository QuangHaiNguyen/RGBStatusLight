...
${OBJECTDIR}/scheduler/Test_Task_1s.o: scheduler/Test_Task_1s.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/scheduler" 
	@${RM} ${OBJECTDIR}/scheduler/Test_Task_1s.o.d 
	@${RM} ${OBJECTDIR}/scheduler/Test_Task_1s.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -I"mcc_generated_files/config" -I"mcc_generated_files/winc" -I"mcc_generated_files/drivers" -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/scheduler/Test_Task_1s.o.d" -MT "${OBJECTDIR}/scheduler/Test_Task_1s.o.d" -MT ${OBJECTDIR}/scheduler/Test_Task_1s.o -o ${OBJECTDIR}/scheduler/Test_Task_1s.o scheduler/Test_Task_1s.c 
	
${OBJECTDIR}/scheduler/Test_Task_2s.o: scheduler/Test_Task_2s.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/scheduler" 
	@${RM} ${OBJECTDIR}/scheduler/Test_Task_2s.o.d 
	@${RM} ${OBJECTDIR}/scheduler/Test_Task_2s.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -I"mcc_generated_files/config" -I"mcc_generated_files/winc" -I"mcc_generated_files/drivers" -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/scheduler/Test_Task_2s.o.d" -MT "${OBJECTDIR}/scheduler/Test_Task_2s.o.d" -MT ${OBJECTDIR}/scheduler/Test_Task_2s.o -o ${OBJECTDIR}/scheduler/Test_Task_2s.o scheduler/Test_Task_2s.c 
